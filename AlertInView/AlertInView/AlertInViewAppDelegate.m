...
#import "AlertInViewAppDelegate.h"

#import "AlertInViewViewController.h"

@implementation AlertInViewAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    AlertInViewViewController *vController = [[AlertInViewViewController alloc] init];
